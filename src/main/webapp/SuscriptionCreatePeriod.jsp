<div> 
	...
	<div id="suscripton-create-member-panel">
		...
		<button class="ui-btn ui-corner-all" id="suscripton-create-member-serach" onclick="javascript:goTo('SuscriptionCreateMember.jsp'); return;">Buscar</button>
	</div>

	<div id="suscripton-create-member-list-panel">
		<label for="suscripton-create-period">Cuota:</label>
		<ul data-role="listview" data-inset="true">
			<li><a href="javascript:goTo('SuscriptionCreateConfirm.jsp');">2020 Anual ($5.000)</a></li>
			<li><a href="javascript:goTo('SuscriptionCreateConfirm.jsp');">2020 Enero ($500)</a></li>
		</ul>
		...
		<button class="ui-btn ui-corner-all" onclick="javascript:goTo('SuscriptionCreateConfirm.jsp');; return;">Pagar</button>
	</div>
</div>
