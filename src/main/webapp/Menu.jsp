<div data-role="panel" id="menu" data-display="overlay"> 
	<ul data-role="listview">
		<li<%=Utils.visibility(request, response, new String[]{"SuscriptionCreateMember.jsp", "SuscriptionSearch.jsp"})%> data-role="list-divider">Cuotas</li>
		<li<%=Utils.visibility(request, response, "SuscriptionCreateMember.jsp")%>><a href="javascript:goTo('SuscriptionCreateMember.jsp');" data-rel="close" class="ui-btn ui-icon-plus ui-btn-icon-right">Pagar Cuota</a></li>
		<li<%=Utils.visibility(request, response, "SuscriptionSearch.jsp")%>><a href="javascript:goTo('SuscriptionSearch.jsp')" data-rel="close" class="ui-btn ui-icon-search ui-btn-icon-right">Buscar Pago</a></li>
		...
		<li><a href="javascript:goTo('PersonSearchPage.jsp');" data-rel="close">Resumen de ventas</a></li>
		<li data-role="list-divider">Administraci&oacute;n</li>
		<li><a href="javascript:goTo('Membership.jsp');" data-rel="close">Cuota</a></li>
