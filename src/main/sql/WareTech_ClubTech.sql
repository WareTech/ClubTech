...
CREATE TABLE IF NOT EXISTS Subscription (
    ...
    PRIMARY KEY  (id),
    CONSTRAINT FK_Subscription_activity FOREIGN KEY (activity) REFERENCES Parameter (id),
    CONSTRAINT FK_Subscription_period FOREIGN KEY (period) REFERENCES Parameter (id),
    UNIQUE KEY UK_Subscription_period_activity (period, activity)
    );
...
INSERT INTO Parameter (id, version,value, description, parent, position) VALUES
    ...
    (301, 0, 'ACTIVITY_NO_ACTIVITY', 'Sin actividad', 300, 1),
    (302, 0, 'ACTIVITY_ZUMBA', 'Zumba', 300, 2),
    (303, 0, 'ACTIVITY_GYM', 'Gimnasia', 300, 3),
    (310, 0, 'ACTIVITY_SOCCER', 'Futbol', 300, 4),
    (320, 0, 'ACTIVITY_SOCCER_FEMALE', 'Femenino', 310, 1),
    (321, 0, 'ACTIVITY_SOCCER_FEMALE_1', '1ra.', 320, 1),
    (322, 0, 'ACTIVITY_SOCCER_FEMALE_3', '3ra.', 320, 2),
    (323, 0, 'ACTIVITY_SOCCER_FEMALE_SUB_18', 'Sub-18', 320, 3),
    (324, 0, 'ACTIVITY_SOCCER_FEMALE_SUB_16', 'Sub-16', 320, 4),
    (325, 0, 'ACTIVITY_SOCCER_FEMALE_SUB_14', 'Sub-14', 320, 5),
    (326, 0, 'ACTIVITY_SOCCER_FEMALE_SUB_10', 'Sub-10', 320, 6),
    (327, 0, 'ACTIVITY_SOCCER_FEMALE_ALEVIN', 'Alevin', 320, 7),
    (350, 0, 'ACTIVITY_SOCCER_MALE', 'Masculino', 310, 2),
    (360, 0, 'ACTIVITY_SOCCER_MALE_MAJOR', 'Mayores', 350, 1),
    (361, 0, 'ACTIVITY_SOCCER_MALE_MAJOR_1', '1ra.', 360, 1),
    (362, 0, 'ACTIVITY_SOCCER_MALE_MAJOR_3', '3ra.', 360, 2),
    (363, 0, 'ACTIVITY_SOCCER_MALE_MAJOR_4', '4ta.', 360, 3),
    (364, 0, 'ACTIVITY_SOCCER_MALE_MAJOR_SR', 'Senior', 360, 4),
    (370, 0, 'ACTIVITY_SOCCER_MALE_YOUTH', 'Juveniles', 350, 2),
    (371, 0, 'ACTIVITY_SOCCER_MALE_YOUTH_5', '5ta.', 370, 1),
    (372, 0, 'ACTIVITY_SOCCER_MALE_YOUTH_6', '6ta.', 370, 2),
    (373, 0, 'ACTIVITY_SOCCER_MALE_YOUTH_7', '7ma.', 370, 3),
    (374, 0, 'ACTIVITY_SOCCER_MALE_YOUTH_8', '8va.', 370, 4),
    (375, 0, 'ACTIVITY_SOCCER_MALE_YOUTH_9', '9na.', 370, 5),
    (376, 0, 'ACTIVITY_SOCCER_MALE_YOUTH_10', 'Pre 9na.', 370, 6),
    (380, 0, 'ACTIVITY_SOCCER_MALE_INFANTILE', 'Infantiles', 350, 3),
    (381, 0, 'ACTIVITY_SOCCER_MALE_INFANT_2010', '2010', 380, 1),
    (382, 0, 'ACTIVITY_SOCCER_MALE_INFANT_2011', '2011', 380, 2),
    (383, 0, 'ACTIVITY_SOCCER_MALE_INFANT_2012', '2012', 380, 3),
    (384, 0, 'ACTIVITY_SOCCER_MALE_INFANT_2013', '2013', 380, 4),
    (385, 0, 'ACTIVITY_SOCCER_MALE_INFANT_2014', '2014', 380, 5),
    (386, 0, 'ACTIVITY_SOCCER_MALE_INFANT_SCHOOL', 'Escuelita', 380, 6),
    ...
    (405, 0, 'STATUS_PRE_SIGNED', 'Pre Inscripcion', 400, null),
